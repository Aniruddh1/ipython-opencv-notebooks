...
def main():
    ...
    if args.in_file:
        eng = Image_Engine(args.in_file, is_glob=args.is_glob)
    ...
    while ret:
        ...
        ellipse, debug = ip.findEllipse(img, center, diag_len, verbose, False)
        ...
        if ellipse[0][0] == -99:
            ...
            if args.do_plot: output = np.concatenate((fg_img, debug), axis=1)
